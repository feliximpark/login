...
#imports for oauth-authorisation
...
#declaring ID by referencing client secrets file
...
#    code = request.data
#    try:
#        # upgrade authoization code into a credentials object
#        oauth_flow = flow_from_clientsecrets('client_secrets.json', scope='')
#        oauth_flow.redirect_uri = 'postmessage'
#        credentials = oauth_flow.step2_exchange(code)
#    #wenn bei dieser Abfrage ein Fehler auftaucht
#    except FlowExchangeError: 
#        response = make_response(json.dumps('Failes to upgrade the authorization code.'), 401)
#        response.headers['Content-Type'] = 'application/json'
#        return response
...
#
#    #Get user-info
#    userinfo_url = "https://www.googleapis.com/oauth2/v1/userinfor"
...
#
#    #hier schaffe ich eine Response, die den Namen, das Bild und die E-Mail des
#    # Nutzers kennt. 
#
#    output = ''
#    output += '<h1>Welcome, '
...
# Get user info
    ...
    # Check ob frisch eingeloggter Nutzer schon einen User-Account bei uns hat
    #Wenn nicht, legen wir einen an und schreiben seine Nutzer_id in die 
    #loggin session
...
#DISCONNECT
#Hier kommt der Disconnect vom Google-Account
